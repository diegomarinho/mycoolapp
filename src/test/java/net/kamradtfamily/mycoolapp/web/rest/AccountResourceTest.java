package net.kamradtfamily.mycoolapp.web.rest;

import net.kamradtfamily.mycoolapp.Application;
import net.kamradtfamily.mycoolapp.config.MongoConfiguration;
import net.kamradtfamily.mycoolapp.domain.Authority;
import net.kamradtfamily.mycoolapp.domain.User;
import net.kamradtfamily.mycoolapp.repository.AuthorityRepository;
import net.kamradtfamily.mycoolapp.repository.UserRepository;
import net.kamradtfamily.mycoolapp.security.AuthoritiesConstants;
import net.kamradtfamily.mycoolapp.service.MailService;
import net.kamradtfamily.mycoolapp.service.UserService;
import net.kamradtfamily.mycoolapp.web.rest.dto.UserDTO;
